...
CSRF_TRUSTED_ORIGINS=['https://marathonapi.fastduka.co.ke']
...
FASTDUKA_API_KEY = os.getenv('FASTDUKA_API_KEY')
FASTDUKA_URL = os.getenv('FASTDUKA_URL', 'https://api.fastduka.com')  # Default URL
FASTDUKA_B2C_PAYBILL = os.getenv('FASTDUKA_B2C_PAYBILL')

AUTH_USER_MODEL = 'users.User'
# AUTHENTICATION_BACKENDS = ['apps.users.backends.EmailBackend'] #updated
